...
/**
 * @Auther: heaven
 * @Date: 2018/6/22 23:31
 * @Description:代码生成器，根据数据表名称生成对应的Model、Mapper简化开发。
 */
public class CodeGenerator {
    // JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://heavenisme.tpddns.cn:3308/fly";
    private static final String JDBC_USERNAME = "root";
    private static final String JDBC_PASSWORD = "heaven870911";
